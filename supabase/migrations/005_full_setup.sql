...
BEGIN
  ...
  VALUES (
    ...
    CASE
      WHEN LOWER(NEW.email) IN ('joyirhyss@gmail.com', 'admin@thepracticecenter.org') THEN 'admin'
      ELSE 'member'
    END
  )
...
INSERT INTO board_seats (id, position, term_start, term_end, election_date, notes)
VALUES
  ('seat-0001-0000-0000-000000000001', 'Board President', '2025-10-01', '2027-09-30', '2026-12-01', 'JoYi: Executive Director & Board President'),
  ('seat-0002-0000-0000-000000000002', 'Board Chair', '2025-10-01', '2027-09-30', '2026-12-01', 'Alison: Board Chair'),
  ('seat-0003-0000-0000-000000000003', 'Secretary', '2025-10-01', '2027-09-30', '2026-12-01', 'Kailani: Board Secretary'),
  ('seat-0004-0000-0000-000000000004', 'Director', '2025-10-01', '2027-09-30', '2026-12-01', 'Gabby: Director, AIdedEQ'),
  ('seat-0005-0000-0000-000000000005', 'Director', '2025-10-01', '2027-09-30', '2026-12-01', 'Jay: Board Member'),
  ('seat-0006-0000-0000-000000000006', 'Director', '2025-10-01', '2027-09-30', '2026-12-01', 'Kobe: Board Member')
ON CONFLICT (id) DO NOTHING;
...
-- Next: Create user accounts (see guide).
-- =====================
